...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        "Привет! Я Лайвбот — твой помощник на территории ЖК.\n"
        "Я помогу найти то, что ты ищешь.\n"
        "Если чего-то нет в списке — ты можешь написать администратору.\n\n"
        "Нажми на ту кнопку, тема которой тебя интересует. 👇"
    )
    ...
    buttons = [
        ...
        ["Найти сервис", "Найти мастера"],
        ["Акции и скидки", "Правила канала"],
        ["Получить 150 ₽", "Поиграть"],
        ["Задать вопрос", "Важные контакты"],
    ]
